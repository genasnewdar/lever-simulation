...
//       ? "border border-rule rounded-t-lg"
//       : isLastFormQuestion
//         ? "border-x border-b border-rule rounded-b-lg"
//         : "border-x border-b border-rule";
...
//           <div className="mb-3">
//             <div className="p-3">
//               <p className="text-xs font-semibold text-red-700 tracking-widest uppercase">
...
//               </p>
//               {maxWordsText && (
//                 <p className="mt-2 text-sm font-semibold text-mint-deep">
//                   {maxWordsText}
//                 </p>
//               )}
//             </div>
//             <div className="px-3 pb-2 text-sm font-semibold text-ink">
//               Registration Form
//             </div>
//           </div>
//         )}
...
//         >
//           <div className="px-4 py-2.5 flex items-center text-sm font-medium text-ink">
//             {label.trim()}
//           </div>
//           <div className="px-4 py-2.5 flex items-center gap-2">
//             <span className="inline-flex items-center justify-center w-7 h-7 rounded bg-gray-900 text-white text-xs font-semibold">
//               {qNum}
//             </span>
//             <input
//               {...register(`gap_${qNum}`)}
//               disabled={disabled}
//               placeholder="..."
//               className="flex-1 border-b-2 border-bordercolor focus:border-mint outline-none px-3 py-1 font-medium text-ink bg-paper-2 rounded-t transition-all"
//             />
//           </div>
//         </div>
//       </div>
...
//   return (
//     <div className="p-6 border rounded-md bg-paper-2 hover:shadow-md transition-shadow">
//       <div className="flex flex-wrap items-center gap-y-4 gap-x-1 leading-relaxed text-base text-ink">
...
//               >
//                 <span className="absolute -top-6 left-1/2 -translate-x-1/2 bg-ink text-paper text-[10px] px-1.5 py-0.5 rounded font-semibold">
//                   {num}
//                 </span>
//                 <input
//                   {...register(inputId)}
//                   disabled={disabled}
//                   placeholder="..."
//                   className="border-b-2 border-bordercolor focus:border-mint outline-none px-3 py-1 w-32 font-medium text-ink bg-paper-2 rounded-t transition-all"
//                 />
//               </div>
//             );
//           }
...
//         <div className="mt-4">
//           <p className="text-xs font-semibold text-amber-700 uppercase tracking-wide bg-amber-50 px-3 py-1.5 rounded border border-amber-200">
//             Write NO MORE THAN {validationRules.maxWords} WORD
//             {validationRules.maxWords !== 1 ? "S" : ""}
//           </p>
//         </div>
      ...
      <div className="w-full font-sans">
        ...
        {qNum === 1 && (
          <div className="bg-white">
            <h2 className="text-[17px] font-semibold uppercase mb-0.5">
              SECTION 1:
            </h2>
            <h3 className="text-[#2b5a9e] font-semibold text-[17px] mb-1">
              Questions 1-10
            </h3>
            <p className="italic text-ink text-[14px] mb-4 font-medium">
              Complete the form below.
            </p>

            <p className="font-semibold italic text-[14px] mb-4">
              Write{" "}
            ...
            <h4 className="text-xl font-semibold border-b-2 border-rule pb-1 italic mb-0">
              Registration Form
            </h4>

            {/* EXAMPLE SECTION */}
            <div className="grid grid-cols-[1.2fr_2fr] border-x border-b border-rule bg-paper-2 italic font-semibold">
              <div className="p-2 border-r border-rule">Example</div>
              <div className="p-2"></div>
            </div>
            <div className="grid grid-cols-[1.2fr_2fr] border-x border-b border-rule">
              <div className="p-2 border-r border-rule italic bg-paper">
                Type of crime reported:
              </div>
              <div className="p-2 font-semibold italic bg-white pl-4">robbery</div>
            </div>
          </div>
        )}
        ...
        {qNum === 9 && (
          <div className="grid grid-cols-1 border-x border-b border-rule bg-white">
            <div className="p-2 font-semibold italic">
        ...
        <div className="grid grid-cols-[1.2fr_2fr] border-x border-b border-rule hover:bg-paper-2 transition-colors">
          {/* Зүүн тал: Label */}
          <div className="p-2 border-r border-rule bg-white flex items-center italic text-[15px] font-medium min-h-[42px]">
            {label.trim()}
          </div>
          ...
          <div className="p-2 flex items-center gap-2 bg-white relative">
                ...
                <div className="flex items-center gap-2 whitespace-nowrap animate-in fade-in slide-in-from-left-2 duration-300">
                  {isCorrect ? (
                    ...
                    <div className="flex items-center gap-1">
                      <span className="text-mint-deep font-semibold text-sm">✗</span>
                      <span className="bg-green-50 text-green-700 text-xs px-1.5 py-0.5 rounded border border-green-200 font-semibold">
                        {correctAnswer}
                      </span>
                    </div>
                  )}
            ...
            {suffix && (
              <span className="italic text-[15px] text-ink-soft">
                {suffix.trim()}
              </span>
            )}
