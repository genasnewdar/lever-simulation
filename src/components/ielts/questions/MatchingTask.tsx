                  ...
                  <div className="min-w-[140px]">
                    {hasItems ? (
                      <select
                        ...
                        className={`w-full p-3 border border-rule rounded-lg focus:ring-2 focus:ring-blue-500 bg-paper text-ink font-semibold text-center outline-none transition-all ${
                          disabled
