  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <button 
        ...
        className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest bg-black/20 hover:bg-black/40 text-white rounded transition-colors border border-white/10"
      >
        {isVisible ? 'Hide' : 'Show'}
      </button>
    </div>
